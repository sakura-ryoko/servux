...
public class ServuxIntSetting extends AbstractServuxSetting<Integer>
{
    ...
    public ServuxIntSetting(String name, Text prettyName, String comment, Integer defaultValue, int maxValue, int minValue)
    {
    ...
    public ServuxIntSetting(String name, Text prettyName, String comment, Integer defaultValue)
    {
