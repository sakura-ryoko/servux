...
public enum LayerMode implements StringIdentifiable
{
    ...
    public static final IntFunction<LayerMode> INDEX_TO_VALUE = ValueLists.createIdToValueFunction(LayerMode::getIndex, values(), ValueLists.OutOfBoundsHandling.WRAP);
