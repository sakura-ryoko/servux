...
// TODO; Add more languages (& Credits) as needed
public enum i18nOption
{
	AF_ZA   ("af_za", "Afrikaans", List.of()),
	AR_SA   ("ar_sa", "العربية (العالم العربي)", List.of()),
	AST_ES  ("ast_es","Asturianu", List.of()),
	AZ_AZ   ("az_az", "Azərbaycanca", List.of()),
	BA_RU   ("ba_ru", "Башҡортса", List.of()),
	BAR     ("bar",   "Bairisch", List.of()),
	BE_BY   ("be_by", "Беларуская", List.of()),
	BG_BG   ("bg_bg", "Български", List.of()),
	BR_FR   ("br_fr", "Brezhoneg", List.of()),
	BRB     ("brb",   "Brabants", List.of()),
	BS_BA   ("bs_ba", "Bosanski", List.of()),
	CA_ES   ("ca_es", "Català (Catalunya)", List.of()),
	CS_CZ   ("cs_cz", "Čeština (Česko)", List.of()),
	CY_GB   ("cy_gb", "Cymraeg", List.of()),
	DA_DK   ("da_dk", "Dansk", List.of()),
	DE_AT   ("de_at", "Deutsch (Österreich)", List.of()),
	DE_CH   ("de_ch", "Deutsch (Schweiz)", List.of()),
	DE_DE   ("de_de", "Deutsch (Deutschland)", List.of()),
	EL_GR   ("el_gr", "Ελληνικά (Ελλάδα)", List.of()),
	EN_AU   ("en_au", "English (Australia)", List.of()),
	EN_GB   ("en_gb", "English (UK)", List.of()),
	EN_NZ   ("en_nz", "English (New Zealand)", List.of()),
	EN_PT   ("en_pt", "Pirate Speak", List.of()),
	EN_UD   ("en_ud", "sɥslƃuǝ (ʞ∩)", List.of()),
	EN_US   ("en_us", "English (US)", List.of("masa", "sakura-ryoko")),
	EO_UY   ("eo_uy", "Esperanto", List.of()),
	ES_AR   ("es_ar", "Español (Argentina)", List.of()),
	ES_CL   ("es_cl", "Español (Chile)", List.of()),
	ES_EC   ("es_ec", "Español (Ecuador)", List.of()),
	ES_ES   ("es_es", "Español (España)", List.of("DanteMezz", "typomc", "garciarojodiego")),
	ES_MX   ("es_mx", "Español (México)", List.of()),
	ES_UY   ("es_uy", "Español (Uruguay)", List.of()),
	ES_VE   ("es_ve", "Español (Venezuela)", List.of()),
	ET_EE   ("et_ee", "Eesti", List.of()),
	EU_ES   ("eu_es", "Euskara", List.of()),
	FA_IR   ("fa_ir", "فارسی", List.of()),
	FI_FI   ("fi_fi", "Suomi (Suomi)", List.of()),
	FIL_PH  ("fil_ph","Filipino (Pilipinas)", List.of()),
	FO_FO   ("fo_fo", "Føroyskt", List.of()),
	FR_CA   ("fr_ca", "Français (Canada)", List.of()),
	FR_FR   ("fr_fr", "Français (France)", List.of()),
	FRA_DE  ("fra_de","Fränkisch", List.of()),
	FY_NL   ("fy_nl", "Frysk", List.of()),
	GA_IE   ("ga_ie", "Gaeilge (Éire)", List.of()),
	GD_GB   ("gd_gb", "Gàidhlig", List.of()),
	GL_ES   ("gl_es", "Galego", List.of()),
	HAW_US  ("haw_us","ʻŌlelo Hawaiʻi", List.of()),
	HE_IL   ("he_il", "עברית", List.of()),
	HI_IN   ("hi_in", "हिंदी (भारत)", List.of()),
	HR_HR   ("hr_hr", "Hrvatski (Hrvatska)", List.of()),
	HU_HU   ("hu_hu", "Magyar (Magyarország)", List.of()),
	HY_AM   ("hy_am", "Հայերեն", List.of()),
	ID_ID   ("id_id", "Bahasa Indonesia", List.of()),
	...
	JBO_EN  ("jbo_en","Lojban", List.of()),
	KA_GE   ("ka_ge", "ქართული", List.of()),
	KK_KZ   ("kk_kz", "Қазақша", List.of()),
	KN_IN   ("kn_in", "ಕನ್ನಡ", List.of()),
	KO_KR   ("ko_kr", "한국어 (대한민국)", List.of("MagPlum")),
	KSH     ("ksh",   "Kölsch", List.of()),
	KW_GB   ("kw_gb", "Kernewek", List.of()),
	LA_LA   ("la_la", "Latina (Latium)", List.of()),
	LB_LU   ("lb_lu", "Lëtzebuergesch", List.of()),
	LI_LI   ("li_li", "Limburgs (Limburg)", List.of()),
	LMO     ("lmo",   "Lumbaart", List.of()),
	...
	MT_MT   ("mt_mt", "Malti", List.of()),
	NAH     ("nah",   "Nāhuatl", List.of()),
	NDS_DE  ("nds_de","Plattdüütsch", List.of()),
	NL_BE   ("nl_be", "Vlaams (België)", List.of()),
	NL_NL   ("nl_nl", "Nederlands (Nederland)", List.of()),
	NN_NO   ("nn_no", "Norsk nynorsk", List.of()),
	NO_NO   ("no_no", "Norsk bokmål", List.of()),
	OC_FR   ("oc_fr", "Occitan", List.of()),
	PL_PL   ("pl_pl", "Polski (Polska)", List.of()),
	PT_BR   ("pt_br", "Português (Brasil)", List.of()),
	PT_PT   ("pt_pt", "Português (Portugal)", List.of()),
	QYA_AA  ("qya_aa","Quenya", List.of()),
	...
	TLH_AA  ("tlh_aa","tlhIngan Hol", List.of()),
	TOK     ("tok",   "Toki Pona", List.of()),
	TR_TR   ("tr_tr", "Türkçe (Türkiye)", List.of("Carex", "egeesin")),
	TT_RU   ("tt_ru", "Татарча", List.of()),
