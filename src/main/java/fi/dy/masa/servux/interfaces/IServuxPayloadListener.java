...
public interface IServuxPayloadListener
{
    ...
    default void encodeServuxPayload(NbtCompound data, ServerPlayerEntity player, Identifier id) { }
    default void decodeServuxPayload(NbtCompound data, ServerPlayerEntity player, Identifier id) { }
}
